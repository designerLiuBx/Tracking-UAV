...
(cl:in-package usb_cam_python-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name usb_cam_python-msg:<Num> is deprecated: use usb_cam_python-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usb_cam_python-msg:num-val is deprecated.  Use usb_cam_python-msg:num instead.")
  (num m))
